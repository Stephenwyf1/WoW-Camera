...
class ReadingPicturesWritingPoems(hub.Module):
    ...
    def WritingPoem(self, image, use_gpu=False):
        ...
        print(f"results_keywords:{results_keywords}")
        ...
        print(f"FirstPoetry:{FirstPoetry}")
