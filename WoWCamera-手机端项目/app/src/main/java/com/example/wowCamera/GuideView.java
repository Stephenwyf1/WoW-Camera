...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void setCustomGuideView1(View customGuideView) {
        this.customGuideView1 = customGuideView;
        if (!first) {
            restoreState();
        }
    }

    public void setCustomGuideView2(View customGuideView) {
        this.customGuideView2 = customGuideView;
        if (!first) {
            restoreState();
        }
    }
    ...
    public void hide() {
        Log.v(TAG, "hide");
        if (customGuideView1 != null || customGuideView2 != null) {
    ...
    private void createGuideView() {
        ...
        if (customGuideView1 != null || customGuideView2 !=null) {
            ...
            this.addView(customGuideView1, guideViewParams);
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setCustomGuideView(View view) {
            guiderView.setCustomGuideView1(view);
            return instance;
        }
